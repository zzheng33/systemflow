# Agentic AI Workflow for XRS Resource Modeling

## Purpose

This workflow turns the current notebook-based XRS performance modeling process into a human-in-the-loop agentic AI pipeline.
...
- running PtychoPINN and Pty-chi experiments
...
The experiment models X-ray scattering reconstruction workloads, especially ptychography. It compares two reconstruction backends:
